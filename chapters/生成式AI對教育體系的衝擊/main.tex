...
\chapterauthor{資訊教育研究所 陳慶霖、機電工程學系 鍾詠傑、科技應用與人力資源發展學系 林吟貞、音樂學系碩士班 林駿甫}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/生成式AI對教育體系的衝擊/purdue-ai-panic.png}
    \caption{美國普渡大學 CS240 課程因 AI 使用偵測引發校園爭議，顯示 AI 工具進入教育現場後，學術誠信、程序正義與評量方式必須被重新檢視。資料來源：\textit{The Purdue Exponent}\protect\cite{arun2026ai}。}
    \label{fig:purdue-ai-panic}
\end{figure}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/生成式AI對教育體系的衝擊/unesco-ai-competency.png}
    \caption{UNESCO 於 2024 年發布《學生人工智慧素養架構》，將學生 AI 素養整理為四個核心維度與三個漸進層次，提供各國制定課程與能力指標時的參考。資料來源：UNESCO\protect\cite{unesco2024competency}。}
    \label{fig:unesco-ai-competency}
\end{figure}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/生成式AI對教育體系的衝擊/moe-ai-guides.png}
    \caption{教育部針對不同學習階段編製生成式 AI 學習應用手冊，反映臺灣政策已從單純限制工具使用，逐漸轉向建立學生 AI 素養與使用規範。資料來源：教育部相關公告\protect\cite{govtw2024aiguide}。}
    \label{fig:moe-ai-guides}
\end{figure}
...
\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{chapters/生成式AI對教育體系的衝擊/uk-dfe-genai-education.png}
    \caption{英國教育部發布生成式 AI 教育政策文件，鼓勵教育者善用 AI 提升效率，同時要求學校重視資料保護、兒少安全與深偽等風險。資料來源：UK Department for Education\protect\cite{dfe2023genai}。}
    \label{fig:uk-dfe-genai-education}
\end{figure}
...
本報告為了解教學現場師生對生成式人工智慧（AI）融入教育的看法，因此採用問卷調查法進行資料蒐集。根據生成式AI於教育領域的應用現況及相關文獻資料，自行設計教師版與學生版兩份問卷，以了解師生對AI工具的使用情形、態度及影響認知。
...
\subsubsection{構面一：使用方式}\label{sec:構面一}
...
此一傾向亦可與教師端對學生使用 AI 輔助學習的觀察相互參照（見第 \ref{sec:教師觀點} 節）。


\subsubsection{構面二：依賴程度}\label{sec:構面二}
...
此一結果與教師端對學生思考能力普遍存有的擔憂形成對照（見第 \ref{sec:教師觀點} 節）。


\subsubsection{構面三：學習行為改變}\label{sec:構面三}
...
整體而言，學生對 AI 在學習效率與理解上的幫助持中性偏正向的態度，尚未形成普遍性的高度認同。

\subsubsection{構面四：倫理與使用態度}\label{sec:構面四}
...
此部分共十六位中小學教師參與調查，包含十三位國中教師及三位國小教師，以了解現場教師對AI融入教學的看法。教師的任教學科涵蓋科技與國文科各五位、英文學科三位，社會、自然及特教領域各有一位。就教學年資而言，受訪群體具備豐富的教學現場經驗，其中教學年資達十五年以上者共八位，十一至十五年者兩位，而初任教師（一至五年）則有六位。

\subsubsection{量化分析結果}

針對教師對生成式AI的核心態度，本研究採用一至五分的李克特尺度進行量化評估，並將第十至第十五題整理為四個分析構面。
...
\bottomrule
\endlastfoot
10. 我認為 AI 能提升教學效率 & 4.44 & 0.629 \\
\end{longtable}

Q10 平均數高達 4.44，顯示教師們高度認同生成式AI在教學工作上的正面影響。從開放式問卷的回覆中也可以發現，教師主要將 AI 應用於「備課」（68.8\%）、「教材製作」（68.8\%）及「出題目」（62.5\%）。這些結果說明，生成式AI大幅減少了行政與瑣碎事務的處理時間，讓教師能更專注於學生輔導。
...
\bottomrule
\endlastfoot
11. 我認為 AI 有助於學生自主學習 & 3.56 & 1.094 \\
12. 我認為 AI 會降低學生思考能力 & 4.00 & 0.730 \\
\end{longtable}

教師的看法呈現拉鋸。對於「有助於學生自主學習」（Q11）持偏向中立的態度，顯示生成式AI是否促進學習仍高度取決於學生自身的學習動機與策略。但對於「AI 會降低學生思考能力」（Q12，M = 4.00）則有較高的共識，反映教學現場普遍擔憂學生可能因便利性而弱化主動思考。
...
\bottomrule
\endlastfoot
13. 我認為 AI 讓作業評量變得困難 & 3.19 & 1.109 \\
15. 我認為 AI 會改變未來教育模式 & 4.63 & 0.619 \\
\end{longtable}

Q15 的平均數（4.63）反映出教師普遍極度認同 AI 將帶來未來教育模式的巨大轉變。儘管對於「作業評量是否變困難」（Q13）看法較為分歧（M = 3.19），但許多教師已開始主動調整評量方式。此結果也顯示，評量困難並非單純來自工具本身，而與教師是否重新設計作業與課堂活動密切相關。
...
\bottomrule
\endlastfoot
14. 我認為教師需要具備 AI 素養 & 4.69 & 0.479 \\
\end{longtable}

Q14 的平均數為所有題目中最高（4.69），標準差（0.479）極小，顯示教師們對於「具備 AI 素養」的需求有極度一致的高度共識。換言之，教師並未將生成式AI視為單純外部威脅，而是認為自身必須具備理解、判斷與引導學生使用工具的專業能力。

\subsubsection{開放式回饋}

在開放式回饋中，教師指出生成式AI的引入帶來了教師端正面賦能與學生端負面衝擊的強烈對比。主要改變可歸納為\textbf{三個核心面向}。

首先是\textbf{教師備課與行政效率的提升}。多位科技、國小及語文科教師指出，該技術大幅減少了備課與撰寫行政文件的時間，使教師能將更多精力專注於教學設計與學生輔導。一位國小科技科教師在回覆中明確指出：「AI 大幅減少老師備課與行政工作的時間……讓教師能更專注於教學與學生輔導。」

其次是\textbf{學生學習型態的兩極化轉變}。一方面，部分學生出現被動依賴與思考退化的現象，傾向直接尋求現成答案而減少了主動探究的過程，導致教師需花費更多心力辨識作業的原創性；有教師觀察到學生「不願意思考只想要現成的回饋」，也有教師表示需要「調整收到濫用 AI 的作業時的心情」。另一方面，該技術也降低了創作與探究的門檻，使原本缺乏動力的學生更願意主動向系統提問。一位科技科教師分享：「以前學生不會就不做，現在不會，他們會問AI。」也有教師認為「AI 讓創作門檻降低了，學生可以快速製作音樂、影片與簡報」。

最後是\textbf{教學互動模式的轉變}。由於資訊生成速度極快，教師角色正從單向的知識傳授者，轉變為引導者與檢驗者，必須具備更強的資訊辨識能力，以應對學生透過科技獲取的龐雜資訊。

在學習成效方面，教師認為AI能即時解答疑惑，對低成就或性格內向的學生具有輔助效果；但AI帶來的資訊真偽的問題與依賴性，相當依賴學生的批判能力。防守策略上，教師將重要寫作與評量限制在課堂內以紙筆或口說形式執行，以驗證學生的真實能力。引導策略上，語文與社會科教師將其作為教學鷹架，例如要求學生分析系統修改句子的合理性，或引導學生批判系統整理的數據，藉此培養學生的批判性思考。關於課綱學習目標，教師普遍認為大原則不變，但教學重點應從死記背誦轉向理解、脈絡與判斷，閱讀理解、問題解決與資訊判讀素養等基礎能力在科技時代顯得更為關鍵。

綜上所述，臺灣中小學教育現場正處於人工智慧衝擊的過渡期。教師在運用AI提高備課效率的同時，也警覺學生因AI而放棄思考的危機。親師生需建立正確觀念，將其定位為輔助工具，著重培養學生的素養與倫理，教師端自身亦需主動擁抱科技並提升專業知能，以掌握教學的平衡點。未來的教育政策與學校支持系統應著重於幫助教師發展引導學生批判科技內容的教案，並設計更具防弊功能且能引導高層次。
...
\subsection{AI的角色}\label{sec:AI角色}
...
\subsection{優缺點比較}\label{sec:優缺點比較}
...
\section{學校教育中是否應全面開放學生使用生成式AI？}\label{sec:學校教育中是否應全面開放學生使用生成式AI？}

\subsection{組員立場：我們的觀點}\label{sec:組員立場}
...
我認為AI應融入教學中。生成式AI使得學生能更無邊際地學習，甚至更能適性引導，在教師端也更能節省繁瑣的行政流程與備課的效率。況且，依照現在的技術也無法準確檢測學生的作業為AI與否。AI融入教育是必然的趨勢。
